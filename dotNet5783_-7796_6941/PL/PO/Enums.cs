...
//______________________________________productEnums_________________________________________________

public enum Hebrew_CATEGORY
{
    מסתורין, פנטזיה, היסטוריה, מדע, ילדים, רומן, בישול_ואפייה, פסיכולוגיה, קודש
}
